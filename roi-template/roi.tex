...
\hline
\textbf{Test Case ID} & test\_date\_invalid.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_date\_invalid\_February.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_tuple\_without\_date.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_negative\_market\_value.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_dates\_non\_unique.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_dates\_non\_ordered.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_withdraw.csv \\ 
\hline
...
\begin{tabular}{|p{1.2in}|p{4in}|}
\hline
\textbf{Test Case ID} & test\_grow.csv \\ 
\hline
